    ...
    <div id="wgn-wrap" class="wrap">
        ...
        <div id="support">
        <?php  
        $message = sprintf (__('If you like this plugin, please rate it in %1$s. You can also support us by %2$s', "wgn-plugin"), '<a href="https://wordpress.org/plugins/wp-gap-notifications" target="_blank">'.__('Wp GAP Notifications page in wordpress.org', "wgn-plugin").'</a>', '<a href="https://zarinp.al/@gapwp" target="_blank" title="donate">'.__("donating", "wgn-plugin").'</a>' );
        echo $message; ?>
        </div>
    </div>
